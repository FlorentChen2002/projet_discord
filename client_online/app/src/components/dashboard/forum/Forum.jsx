...
function Forum({ user }) {
    ...
    const getAllSujet = async() =>{
        try {
            const response = await axios.get('https://projet-discord.onrender.com/api/forum/sujet',{ withCredentials: true });
    ...
    useEffect(() => {
        ...
        getAllSujet();
        const source = new EventSource("https://projet-discord.onrender.com/api/forum/events", {
